...
pacstrap /mnt base base-devel linux linux-firmware linux-headers nano sudo ntfs-3g git zsh grub networkmanager efibootmgr os-prober wget xorg-server plasma kde-applications lightdm docker jdk17-openjdk maven steam
